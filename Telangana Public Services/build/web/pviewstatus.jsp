...
<body>	
    ...
    <li><a href="pviewcomplaints.jsp">View Complaints</a></li>
    <li class="btn active"><a href="pviewstatus.jsp">View Status</a></li>
    ...
    String sql="select * from complaints where location = '"+location+"' and department = '"+department+"' and status = 'Solved'"; 
    Statement st=con.createStatement();
    ResultSet rs=st.executeQuery(sql);
    
    if(rs.next()){
    
    String sql2="select * from complaints where location = '"+location+"' and department = '"+department+"' and status = 'Solved'"; 
   ...
   %>
    ...
    <td><font color="black"><%=rs1.getString("status")%></td>
     </tr>
       <%
       }
       %>
