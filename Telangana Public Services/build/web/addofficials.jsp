...
<body>	
    ...
    <li class="btn active"><a href="addofficials.jsp">Add Officials</a></li>
    ...
    <p align="justify">
    <center><p><font color="red" size="5">Add Govt Officials</font></p>
    <form name="myform" action="Register" method="get" onsubmit="return validateform()">
    <table width="371">
    <tr>
    ...
    <td><select name="type" style="width:220px;" required="">
    ...
    <td><input type="text" name="location" autocomplete="off" required="" placeholder="Location"></input></td>
    </tr>
    <tr>
