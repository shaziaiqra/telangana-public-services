...
<body>	
    ...
    <ul>
    <li><a href="bankinghome.jsp">Home</a></li>															
    <li class="btn active"><a href="bankviewcomplaints.jsp">View Complaints</a></li>
   ...
   %>
    ...
    <td><a href="solve1.jsp?username=<%=rs1.getString(1)%>&subject=<%=rs1.getString(4)%>"><button type="button">Solve </button></a></td>
    </tr>
       <%
       }
       %>
