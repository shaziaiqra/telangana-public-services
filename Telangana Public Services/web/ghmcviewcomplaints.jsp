...
<body>	
    ...
    <li class="btn active"><a href="ghmcviewcomplaints.jsp">View Complaints</a></li>
   ...
   %>
    ...
    <td><a href="solve2.jsp?username=<%=rs1.getString(1)%>&subject=<%=rs1.getString(4)%>"><button type="button">Solve </button></a></td>
    </tr>
       <%
       }
       %>
