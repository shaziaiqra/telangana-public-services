...
<body>	
    ...
    <li class="btn active"><a href="complaint.jsp">Services</a></li>
    ...
    <p align="justify">
    <center><p><font color="red" size="5">Complaint Form</font></p>
    ...
    <td><select name="location" style="width:220px;" required="">    
    ...
    <tr>
    <td height="65"><font color="black">Subject</td>
    <td><input type="text" name="subject" autocomplete="off" required="" placeholder="Subject"/></td>
    </tr>
    <tr>
    <td height="43"><font color="black">Description </td>
    <td><textarea name="description" cols="25" rows="3" required="" placeholder="Description"></textarea></td>
    </tr>
    <tr>
    <td height="65"><font color="black">File</td>
    <td><input type="file" name="efile" autocomplete="off" required="" /></td>
    </tr>
    <tr>
